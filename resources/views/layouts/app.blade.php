...
<head>
    ...
    <!-- datetimepicker -->
    <link rel="stylesheet" href="{{ URL::asset('assets/plugins/datetimepicker/jquery.datetimepicker.css') }}">
...
<!--Cookie-->
<script src="{{ URL::asset('assets/plugins/cookie/jquery.cookie.js') }}"></script>
<!--end cookie-->
<!-- AdminLTE App -->
